...
This is just a tool to help visualize how this happens. Specifically, the thing to notice is that, [almost all]{https://en.wikipedia.org/wiki/Almost_all} observers see their samples converge to 50% heads and 50% tails (of course, we only collect a very limited number of samples in this simulation, but enough to see the trend).
